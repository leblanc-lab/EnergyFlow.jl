...
@testset "EMD dispatch" begin
    println("  Running EMD dispatch tests")
    ...
    try
        ...
        println("  ns64 = $ns64_val, ot64 = $ot64_val")
        ...
        println("  emd! ns64 = $ns64_inplace, ot64 = $ot64_inplace")
        ...
        println("  emd! ns32 = $ns32_inplace, ot32 = $ot32_inplace")
        ...
        println("  pairwise ns64 = $self_ns")
        println("  pairwise ot64 = $self_ot")
        ...
        println("  sinkhorn emd! = $sink_inplace")
